...
const chatList = [
  {
    ...
    time: '12:30',
    isAccepted: false, // This will track if the chat is accepted
    messages: [
      ...
      <div className="flex-1 flex flex-col bg-white shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3">
          {selectedChat.isAccepted ? (
            ...
            <img src="/api/placeholder/200/200" alt="Trainee" className="w-32 h-32 rounded-full mb-4" />
        ...
        {/* Input Box */}
        {selectedChat.isAccepted && (
        <div className="flex items-center px-4 py-3 border-t w-full max-w-3xl fixed bottom-0 left-0 right-0 mx-auto bg-gray-100">
            <input
            type="text"
