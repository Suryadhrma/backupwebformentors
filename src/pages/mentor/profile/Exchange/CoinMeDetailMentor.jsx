...
const Exchange = () => {
  ...
  // CoinMe balance and exchange rate state
  const [coinMeBalance, setCoinMeBalance] = useState(200); // Example CoinMe balance
  const [exchangeRate, setExchangeRate] = useState(1.5); // Example exchange rate (CoinMe to local currency)
  ...
  return (
    <div className="p-6">
      ...
      {/* CoinMe Balance Container */}
        <div className="bg-white text-center max-w-md p-4 rounded-lg border border-gray-300 mx-auto mb-6">
            <h5 className="text-sm font-semibold mb-3">Jumlah CoinMe Tersedia</h5>
            <div className="flex items-center justify-center">
                <span className="text-lg font-bold">{coinMeBalance} CoinMe</span>
            </div>
        </div>

        {/* Add the SwitchCamera Icon Between CoinMe and IDR */}
        ...
        <div className="bg-white text-center max-w-md p-4 rounded-lg border border-gray-300 mx-auto">
            <h5 className="text-sm font-semibold mb-3">Nilai Tukar CoinMe</h5>
            <div className="flex items-center justify-center">
                <span className="text-lg font-bold">{coinMeBalance * exchangeRate} IDR</span>
            </div>
        </div>
        ...
        <div className="bg-white text-center max-w-md p-4 rounded-lg mb-6 mx-auto">
            <div className="flex justify-between items-center">
                ...
                <button 
                    onClick={() => alert('Tarik Semua CoinMe')} 
