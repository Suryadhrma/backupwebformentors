...
const MoneyMe = () => {
  ...
  const [income, setIncome] = useState(500.000); // Default income
  const [expenses, setExpenses] = useState(0); // Default expenses
  const [details, setDetails] = useState([
    { label: 'Konsultasi', value: '100.000 MM' },
    { label: 'Aktivitas', value: '100.000 MM' },
  ]); // Default details
  ...
  // Handle Tarik MoneyMe button click
  const handleWithdraw = () => {
    navigate('mentor/moneyme/detail'); // Placeholder action
  };
