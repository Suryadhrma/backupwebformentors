...
const HelpCenterMentor = () => {
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* Header Outside of Chat Window */}
      <header className="flex flex-col items-start mb-4 px-4">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col bg-white shadow-xl">
          ...
          {/* Input Box */}
          <div className="flex items-center px-4 py-3 border-t w-full bg-gray-100">
            <input
              type="text"
...
export default HelpCenterMentor;
